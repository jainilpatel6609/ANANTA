...
export default function AdminLayout() {
  ...
  const navItems = [
    ...
    { name: 'Vehicle & Fleet Config', path: '/vehicles', icon: Truck },
    ...
    <div className="min-h-screen bg-slate-950 flex flex-col md:flex-row text-slate-100">
      ...
      >
        ...
        <div className="p-4 border-t border-slate-800 space-y-2">
          <button
            onClick={logout}
            className="w-full flex items-center justify-center gap-2.5 px-3.5 py-2.5 rounded-xl text-xs font-semibold text-rose-400 hover:bg-rose-950/40 border border-rose-900/30 transition-colors"
          >
