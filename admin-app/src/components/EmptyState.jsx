  ...
  return (
    <div className="relative overflow-hidden flex flex-col items-center justify-center p-8 sm:p-12 text-center bg-slate-900/60 backdrop-blur-md border border-slate-800/90 rounded-3xl shadow-lg my-4">
      ...
      <div className="relative z-10 flex flex-col items-center">
        <div className="p-4 sm:p-5 rounded-2xl bg-slate-800/80 border border-slate-700/80 text-amber-400 mb-4 shadow-inner shadow-black/40">
        ...
        {actionText && onAction && (
          <button
            type="button"
            onClick={onAction}
            className="mt-6 px-6 py-3 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 text-xs font-black transition-all shadow-lg shadow-amber-500/25 active:scale-95"
          >
            {actionText}
          </button>
        )}
