...
module.exports = {
  ...
  CLIENT_URLS: (process.env.CLIENT_URLS || process.env.CLIENT_URL || 'http://localhost:3000,http://localhost:3001,http://localhost:5173,http://localhost:5174').split(',').map((s) => s.trim()),
  ...
  SUPER_ADMIN_SECRET: process.env.SUPER_ADMIN_SECRET || process.env.SUPER_ADMIN_SECRET_KEY || 'ANANTA',
  SUPER_ADMIN_SECRET_KEY: process.env.SUPER_ADMIN_SECRET_KEY || process.env.SUPER_ADMIN_SECRET || 'ANANTA'
};
