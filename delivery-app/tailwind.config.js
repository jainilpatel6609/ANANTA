export default {
  ...
  theme: {
    extend: {
      colors: {
        // Same palette as the admin-app: deep executive slate surfaces (see `slate`) paired with a
        // warm champagne/brass gold accent, so all apps share one consistent brand theme.
        amber: {
          50: '#faf8f5',
          100: '#f4ede2',
          200: '#e6dbca',
          300: '#d5c4aa',
          400: '#c5aa7b',
          500: '#b28e4e', // Classic Warm Gold / Brass -- primary accent
          600: '#99763a',
          700: '#7a5a29',
          800: '#5e431c',
          900: '#422f12',
