          ...
          >
            ...
            <div className="relative flex items-end">
              ...
              <svg width="120" height="70" viewBox="0 0 120 70" className="drop-shadow-md">
                {/* Trolley Body */}
                <path d="M 10 25 L 110 25 L 105 52 L 15 52 Z" fill="#111827" stroke="#000000" strokeWidth="2" />
                {/* Sand / Aggregate Load Mound */}
                <path d="M 14 25 Q 60 8 106 25 Z" fill="#c5aa7b" />
                ...
                <g className="animate-spin" style={{ transformOrigin: '35px 54px', animationDuration: '0.6s' }}>
                  <circle cx="35" cy="54" r="14" fill="#111827" stroke="#475569" strokeWidth="3" />
                  <circle cx="35" cy="54" r="6" fill="#b28e4e" />
                ...
                <g className="animate-spin" style={{ transformOrigin: '85px 54px', animationDuration: '0.6s' }}>
                  <circle cx="85" cy="54" r="14" fill="#111827" stroke="#475569" strokeWidth="3" />
                  <circle cx="85" cy="54" r="6" fill="#b28e4e" />
              ...
              <svg width="130" height="85" viewBox="0 0 130 85" className="-ml-3 drop-shadow-lg">
                ...
                {/* Engine Hood / Bonnet */}
                <path d="M 52 34 L 118 36 L 120 54 L 52 54 Z" fill="#0b0f19" stroke="#000000" strokeWidth="2" />
                {/* Grille */}
                ...
                <path d="M 22 20 L 52 20 L 52 54 L 20 54 Z" fill="#c5aa7b" stroke="#99763a" strokeWidth="2" />
                {/* Cabin Glass */}
                <path d="M 26 24 L 48 24 L 48 40 L 26 40 Z" fill="#38bdf8" opacity="0.8" />
                {/* Steering wheel */}
                <line x1="45" y1="36" x2="38" y2="30" stroke="#111827" strokeWidth="2" />
                
                {/* Rear Big Wheel (Rotates) */}
                <g className="animate-spin" style={{ transformOrigin: '32px 58px', animationDuration: '0.6s' }}>
                  <circle cx="32" cy="58" r="22" fill="#0b0f19" stroke="#334155" strokeWidth="4" />
                  <circle cx="32" cy="58" r="10" fill="#b28e4e" stroke="#7a5a29" strokeWidth="2" />
                  {/* Wheel Spoke Lines */}
                ...
                <g className="animate-spin" style={{ transformOrigin: '106px 64px', animationDuration: '0.6s' }}>
                  <circle cx="106" cy="64" r="14" fill="#0b0f19" stroke="#334155" strokeWidth="3" />
                  <circle cx="106" cy="64" r="6" fill="#b28e4e" />
